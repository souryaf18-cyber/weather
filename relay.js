...
const WS_PING_MS    = 10000;   // ms — keepalive ping (must be < Render's 30s idle timeout)
const MAX_QUEUE     = 50;
...
// ── WebSocket server ──────────────────────────────────────────────
// maxPayload: 100MB — prevents relay from closing on large /history frames
// maxPayload: 100MB — prevents relay from closing on large /history frames
// perMessageDeflate: false — avoids CPU overhead on small sensor data frames
